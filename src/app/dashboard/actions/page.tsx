...
export default function ActionsPage() {
  ...
  useEffect(() => {
    const loadActions = async () => {
      ...
      setError(null);
      try {
        const userActions = await getUserActions(user.$id, 50); // Load more actions
        ...
        if (
          ...
          setError("Database not found. Please contact support.");
        }
    ...
    <div className="space-y-6">
      ...
      {loading && (
        ...
        >
          ...
          <p className="text-white/60">Loading your eco actions...</p>
        </motion.div>
      )}
          ...
          >
            <div className="h-full rounded-2xl border border-white/10 bg-white/[0.02] p-4 shadow-lg shadow-black/20 backdrop-blur-2xl">
              ...
              <div className="space-y-4">
                ...
                {/* Daily Challenge */}
                <div className="rounded-lg border border-emerald-500/30 bg-gradient-to-r from-emerald-500/20 to-teal-500/20 p-3">
